...
CREATE TABLE `alarma` (
  ...
  CONSTRAINT `REL_Tip_Alarma` FOREIGN KEY (`idTipoAlarma`) REFERENCES `tipoalarma` (`idTipoAlarma`),
  CONSTRAINT `REL_Zon_Alarma` FOREIGN KEY (`idZona`) REFERENCES `zona` (`idZona`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `alarma` (`idAlarma`,`idZona`,`denominacion`,`descripcion`,`origen`,`fechaCreacion`,`fechaInicio`,`fechaFin`,`idPeriodicidad`,`idTipoAlarma`,`idEstado`,`activado`,`rangoDesde`,`rangoHasta`,`idCargo`) VALUES 
 ...
 (2,2,'Clima alto','Indica que la tarea posee mas de 5 dias de vencida','Actividades','2009-06-10 00:00:00','2009-06-12 00:00:00','2011-06-11 00:00:00',1,1,1,1,5,10,2),
 (3,3,'Clima alto','Indica que la tarea posee mas de 10 dias de vencida','Actividades','2009-06-10 00:00:00','2009-06-12 00:00:00','2011-06-11 00:00:00',1,2,1,1,5,10,3),
 ...
 (5,5,'Clima alto','Indica que la zona no es apta para buena producción','Flora','2009-06-10 00:00:00','2009-06-12 00:00:00','2011-06-11 00:00:00',1,1,1,1,5,10,2),
 (6,1,'Clima alto','Indica que la zona posee demasiados agroquimicos alrededor','Agroquimicos','2009-06-10 00:00:00','2009-06-12 00:00:00','2011-06-11 00:00:00',1,1,1,1,5,10,1),
...
INSERT INTO `empleado` (`legajo`,`nombre`,`apellido`,`idEstadoEmpleado`,`idCargo`,`observaciones`,`usuario`,`password`,`fechaAlta`,`fechaBaja`,`email`) VALUES 
 (1,'Juan Martin','Possi',1,1,'No Comments','','','2009-08-29 00:00:00',NULL,NULL),
 (2,'Ignacio','Tallapiedra',1,2,'No Comments','','','2009-08-29 00:00:00',NULL,NULL),
 (3,'Jesica','Gimenez',1,3,'No Comments','','','2009-08-29 00:00:00',NULL,NULL),
 (4,'Erica','Gomez',1,4,'No Comments','','','2009-08-29 00:00:00',NULL,NULL),
 (5,'Raul','Santos',1,5,'No Comments','','','2009-08-29 00:00:00',NULL,NULL),
 (6,'Matias','Salcedo',1,6,'No Comments','','','2009-08-29 00:00:00',NULL,NULL),
 (7,'Francisco','Martinez',1,7,'No Comments','','','2009-08-29 00:00:00',NULL,NULL),
 (8,'Pedro','Medrano',1,8,'No Comments','','','2009-08-29 00:00:00',NULL,NULL),
 (9,'Valentina','Saez',1,9,'No Comments','','','2009-08-29 00:00:00',NULL,NULL);
