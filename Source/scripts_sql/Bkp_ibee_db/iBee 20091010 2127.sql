...
--
-- Temporary table structure for view `todaslasactividades`
--
DROP TABLE IF EXISTS `todaslasactividades`;
DROP VIEW IF EXISTS `todaslasactividades`;
...
INSERT INTO `actividad` (`idActividad`,`codTipoActividad`,`denominacion`,`descripcion`,`fechaCreacion`,`fechaInicio`,`fechaFin`,`observaciones`,`idApiar`,`idEstado`) VALUES 
 (1,'C','Control General de Apiar','Verificar la higiene del lugar','2009-06-15 00:00:00','2009-06-20 00:00:00','2009-06-30 00:00:00','',1,1),
 (2,'C','Control General de Apiar','Verificar la existencia de abeja reina en todas las colmenas','2009-06-15 00:00:00','2009-06-20 00:00:00','2009-06-30 00:00:00','',2,1),
 (3,'C','Control General de Apiar','Controlar la flora del lugar','2009-06-15 00:00:00','2009-06-20 00:00:00','2009-06-30 00:00:00','',3,1),
 (4,'C','Control General de Apiar','Realizar recorrido de inspección','2009-06-15 00:00:00','2009-06-20 00:00:00','2009-06-30 00:00:00','',4,1),
 (5,'C','Control General de Apiar','Verificar la ubicación del mismo en el mapa','2009-06-15 00:00:00','2009-06-20 00:00:00','2009-06-30 00:00:00','',5,1),
 (6,'C','Control General de Apiar','Revisar hormigueros en las cercanías','2009-06-15 00:00:00','2009-06-20 00:00:00','2009-06-30 00:00:00','',6,1),
 (7,'C','Control General de Apiar','Colocar latas de aceite en las patas de las Colmenas.','2009-06-15 00:00:00','2009-06-20 00:00:00','2009-06-30 00:00:00','',7,1),
 (8,'C','Control General de Apiar','Validar... ta... te... ti','2009-06-15 00:00:00','2009-06-20 00:00:00','2009-06-30 00:00:00','',7,1),
 (9,'C','Control General de Apiar','Actualizar... ta... te... ti','2009-06-15 00:00:00','2009-06-20 00:00:00','2009-06-30 00:00:00','',2,1);
...
--
-- Definition of table `enfermedades`
--
...
CREATE TABLE `enfermedades` (
  ...
  `duracionAproximada` varchar(25) DEFAULT NULL,
  `observaciones` varchar(500) DEFAULT NULL,
  `criticidad` varchar(25) DEFAULT NULL
...
INSERT INTO `localidad` (`idLocalidad`,`nombre`,`latitud`,`longitud`,`temperatura`,`iconoTemperatura`) VALUES 
 ('ARCA0001','Alta Gracia',-31.66,-64.43,13,31),
 ('ARCA0023','Cordoba',-31.4,-64.19,13,31),
 ('ARCA0026','Cruz Del Eje',-30.72,-64.81,13,31),
 ('ARCA0042','La Falda',-31.09,-64.47,13,31),
 ('ARCA0073','Rio Cuarto',-33.13,-64.35,19,31),
 ('ARCA0075','Rio Segundo',-31.67,-63.92,13,31),
 ('ARCA0076','Rio Tercero',-32.18,-64.12,13,31),
 ('ARCA0082','San Francisco',-31.43,-62.09,17,31),
 ('ARCA0108','Villa Carlos Paz',-31.42,-64.5,16,31),
 ('ARCA0110','Villa Dolores',-31.95,-65.15,16,31),
 ('ARCA0124','Marcos Juarez',-32.71,-62.11,17,31),
 ('ARCA0126','Laboulaye',-34.13,-63.39,18,31),
 ('ARCA0191','Villa General Belgrano',-31.98,-64.57,16,31),
 ('ARCA2189','Cruz Alta',-33.02,-61.82,17,31),
 ('ARCA2413','Freyre',-31.17,-62.1,16,31),
 ('ARCA2417','Altos De Chipion',-30.93,-62.28,16,31),
 ('ARCA2421','Morteros',-30.7,-62,16,31),
 ('ARCA2424','Devoto',-31.4,-62.32,17,31),
 ('ARCA2426','La Francia',-31.4,-62.63,NULL,NULL),
 ('ARCA2432','El Tio',-31.39,-62.82,NULL,NULL),
 ('ARCA2433','Villa Concepcion Del Tio',-31.32,-62.83,NULL,NULL),
 ('ARCA2434','Arroyito',-31.42,-63.05,NULL,NULL),
 ('ARCA2436','Transito',-31.42,-63.18,NULL,NULL),
 ('ARCA2550','Bell Ville',-32.62,-62.7,17,31),
 ('ARCA2553','Justiniano Posse',-32.88,-62.67,17,31),
 ('ARCA2557','Idiazabal',-32.8,-63.03,17,31),
 ('ARCA2559','Cintra',-32.25,-62.64,17,31),
 ('ARCA2563','Noetinger',-32.37,-62.32,17,31),
 ('ARCA2568','Morrison',-32.6,-62.83,17,31),
 ('ARCA2572','Ballesteros',-32.55,-62.98,17,31),
 ('ARCA2581','Los Surgentes',-32.97,-62.02,17,31),
 ('ARCA2583','General Baldissera',-33.12,-62.32,17,31),
 ('ARCA2585','Camilo Aldao',-33.13,-62.1,17,31),
 ('ARCA2587','Inriville',-32.94,-62.29,17,31),
 ('ARCA2589','Monte Buey',-32.92,-62.45,17,31),
 ('ARCA2592','General Roca',-32.73,-61.92,17,31),
 ('ARCA2594','Leones',-32.65,-62.3,17,31),
 ('ARCA2624','Arias',-33.63,-62.42,17,31),
 ('ARCA2625','Cavanagh',-33.48,-62.35,17,31),
 ('ARCA2627','Guatimozin',-33.45,-62.45,17,31),
 ('ARCA2645','Corral De Bustos',-33.28,-62.2,17,31),
 ('ARCA2650','Canals',-33.55,-62.88,18,31),
 ('ARCA2651','Viamonte',-33.81,-62.97,18,31),
 ('ARCA2655','Wenceslao Escalante',-33.17,-62.75,17,31),
 ('ARCA2657','Laborde',-33.15,-62.85,17,31),
 ('ARCA2659','Monte Maiz',-33.2,-62.6,17,31),
 ('ARCA2662','Alejo Ledesma',-33.62,-62.62,18,31),
 ('ARCA2670','La Carlota',-33.43,-63.3,18,31),
 ('ARCA2671','Assunta',-33.52,-63.21,18,31),
 ('ARCA2677','Ucacha',-33.03,-63.52,19,31),
 ('ARCA2679','Pascanas',-33.13,-63.05,17,31),
 ('ARCA2681','Etruria',-32.93,-63.25,19,31),
 ('ARCA5105','Villa Allende',-31.3,-64.3,13,31),
 ('ARCA5107','Agua De Oro',-31.07,-64.3,13,31),
 ('ARCA5109','Unquillo',-31.23,-64.32,13,31),
 ('ARCA5111','Rio Ceballos',-31.17,-64.33,13,31),
 ('ARCA5115','La Granja',-31.02,-64.27,13,31),
 ('ARCA5119','Rafael Garcia',-31.65,-64.26,13,31),
 ('ARCA5123','Toledo',-31.57,-64.02,13,31),
 ('ARCA5125','Malvinas Argentinas',-31.35,-63.8,13,31),
 ('ARCA5127','Rio Primero',-31.33,-63.62,13,31),
 ('ARCA5137','La Para',-30.87,-62.98,NULL,NULL),
 ('ARCA5139','Marull',-30.97,-62.83,NULL,NULL),
 ('ARCA5141','Balnearia',-31,-62.67,16,31),
 ('ARCA5143','Miramar',-30.9,-62.67,16,31),
 ('ARCA5155','Tanti',-31.33,-64.6,13,31),
 ('ARCA5166','Cosquin',-31.25,-64.48,13,31),
 ('ARCA5168','Valle Hermoso',-31.12,-64.48,13,31),
 ('ARCA5182','San Esteban',-30.92,-64.55,13,31),
 ('ARCA5184','Capilla Del Monte',-30.85,-64.52,13,31),
 ('ARCA5187','San Clemente',-31.72,-64.63,16,31),
 ('ARCA5191','San Agustin',-31.98,-64.38,13,31),
 ('ARCA5196','Santa Rosa De Calamuchita',-32.07,-64.55,16,31),
 ('ARCA5200','Dean Funes',-30.43,-64.35,13,31),
 ('ARCA5201','La Posta',-30.55,-63.52,13,31),
 ('ARCA5214','Quilino',-30.21,-64.48,13,31),
 ('ARCA5220','Jesus Maria',-30.98,-64.1,13,31),
 ('ARCA5223','Colonia Caroya',-31.03,-64.08,13,31),
 ('ARCA5225','Atahona',-30.83,-63.55,13,31),
 ('ARCA5231','Sebastian Elcano',-30.15,-63.58,13,31),
 ('ARCA5244','San Jose De La Dormida',-30.35,-63.93,13,31),
 ('ARCA5246','Rayo Cortado',-30.08,-63.82,13,31),
 ('ARCA5270','Serrezuela',-30.63,-65.38,19,31),
 ('ARCA5284','Villa De Soto',-30.85,-64.98,13,31),
 ('ARCA5295','Salsacate',-31.32,-65.08,16,31),
 ('ARCA5801','Alpa Corral',-32.68,-64.73,19,31),
 ('ARCA5805','Carnerillo',-32.92,-64.03,19,31),
 ('ARCA5807','Bengolea',-33.03,-63.68,19,31),
 ('ARCA5809','General Cabrera',-32.8,-63.87,19,31),
 ('ARCA5811','Coronel Baigorria',-32.85,-64.35,19,31),
 ('ARCA5813','Alcira',-32.75,-64.33,19,31),
 ('ARCA5815','Elena',-32.57,-64.39,19,31),
 ('ARCA5817','Berrotaran',-32.46,-64.39,19,31),
 ('ARCA5823','Los Condores',-32.33,-64.27,19,31),
 ('ARCA5825','Santa Catalina',-33.2,-64.45,19,31),
 ('ARCA5833','Achiras',-33.17,-65,19,31),
 ('ARCA5837','Suco',-33.45,-64.83,19,31),
 ('ARCA5841','San Basilio',-33.48,-64.32,19,31),
 ('ARCA5843','Adelia Maria',-33.62,-64.03,18,31),
 ('ARCA5847','Coronel Moldes',-33.68,-64.57,19,31),
 ('ARCA5853','Corralito',-32.05,-64.2,13,31),
 ('ARCA5854','Almafuerte',-32.2,-64.25,13,31),
 ('ARCA5856','Embalse',-32.18,-64.42,16,31),
 ('ARCA5862','Villa Del Dique',-32.17,-64.48,16,31),
 ('ARCA5864','Villa Rumipal',-32.18,-64.48,16,31),
 ('ARCA5885','Las Tapias',-31.94,-65.07,16,31),
 ('ARCA5889','Mina Clavero',-31.72,-65,16,31),
 ('ARCA5893','Panaholma',-31.62,-65.11,16,31),
 ('ARCA5901','Ausonia',-32.35,-63.22,17,31),
 ('ARCA5903','Villa Nueva',-32.43,-63.25,17,31),
 ('ARCA5911','La Playosa',-32.1,-63.03,17,31),
 ('ARCA5915','Carrilobo',-31.87,-63.13,17,31),
 ('ARCA5917','Arroyo Cabral',-32.52,-63.43,19,31),
 ('ARCA5919','Dalmacio Velez',-32.6,-63.58,19,31),
 ('ARCA5921','Las Perdices',-32.7,-63.7,19,31),
 ('ARCA5923','General Deheza',-32.73,-63.77,19,31),
 ('ARCA5925','Ticino',-32.69,-63.44,19,31),
 ('ARCA5929','Hernando',-32.42,-63.73,19,31),
 ('ARCA5931','Las Isletillas',-32.38,-63.78,19,31),
 ('ARCA5933','General Fotheringham',-32.29,-63.93,19,31),
 ('ARCA5935','Villa Ascasubi',-32.17,-63.89,13,31),
 ('ARCA5936','Tio Pujio',-32.28,-63.37,19,31),
 ('ARCA5940','Las Varillas',-31.87,-62.72,17,31),
 ('ARCA5945','Sacanta',-31.67,-63.07,NULL,NULL),
 ('ARCA5949','Alicia',-31.99,-62.47,17,31),
 ('ARCA5963','Villa Del Rosario',-31.58,-63.53,13,31),
 ('ARCA5965','Colazo',-31.88,-63.42,NULL,NULL),
 ('ARCA5967','Luque',-31.65,-63.37,NULL,NULL),
 ('ARCA5969','Calchin',-31.67,-63.19,NULL,NULL),
 ('ARCA5972','Pilar',-31.73,-63.88,13,31),
 ('ARCA5974','Laguna Larga',-31.77,-63.8,13,31),
 ('ARCA5980','Oliva',-32.05,-63.57,13,31),
 ('ARCA5984','James Craik',-32.15,-63.47,19,31),
 ('ARCA5986','Oncativo',-31.92,-63.67,13,31),
 ('ARCA6101','La Cesira',-33.95,-62.98,18,31),
 ('ARCA6121','Pacheco De Melo',-33.76,-63.49,18,31),
 ('ARCA6123','Melo',-34.42,-63.57,18,31),
 ('ARCA6125','Serrano',-34.45,-63.55,18,31),
 ('ARCA6128','Villa Rossi',-34.3,-63.27,18,31),
 ('ARCA6132','General Levalle',-34.02,-63.93,18,31),
 ('ARCA6134','Rio Bamba',-34.06,-63.73,18,31),
 ('ARCA6141','Tosquita',-33.83,-64.46,19,31),
 ('ARCA6144','Washington',-33.88,-64.7,19,31),
 ('ARCA6270','Huinca Renanco',-34.83,-64.38,18,31),
 ('ARCA6275','Villa Huidobro',-34.84,-64.58,18,31),
 ('ARCA6354','La Cumbre',-33.73,-64.17,18,31),
...
CREATE TABLE `tarea` (
  ...
  `idResidente` int(15) DEFAULT NULL,
...
INSERT INTO `tarea` (`idActividad`,`idTarea`,`codTipoActividad`,`codTipoTarea`,`descripcion`,`idEstadoTarea`,`fechaRealizacion`,`fechaPrevista`,`observaciones`,`legajoEmpleado`,`idColmena`,`idResidente`,`idFamilia`,`idCajon`,`idSintoma`,`idTratamiento`,`idEnfermedad`) VALUES 
 (1,1,'C','C','Realizar revision General mensual',1,NULL,'2009-09-01 18:00:00','Sin comentarios adicionales',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 (1,2,'C','C','Realizar revision Medica Mensual.',1,NULL,'2009-09-01 18:00:00','Sin comentarios adicionales',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `tipotarea` (`codTipoActividad`,`codTipoTarea`,`denominacion`,`descripcion`,`usaApiar`,`usaFamilia`,`usaCajon`,`usaTratamiento`,`usaEnfermedad`,`usaSintoma`,`idCargo`,`usaColmena`,`usaLayout`,`usaZona`) VALUES 
 ('C','A','Controlar Apiar','Actividades necesarias para controlar un apiar',0,0,1,0,0,0,NULL,NULL,NULL,NULL),
 ('F','A','Fabricar Apiar','Actividades necesarias para fabricar un apiar',0,0,1,0,0,0,NULL,NULL,NULL,NULL),
 ('C','C','Controlar Colmena','Actividades necesarias para controlar una colmena',0,0,0,0,0,0,NULL,NULL,NULL,NULL),
 ('F','C','Fabricar Colmena','Actividades necesarias para fabricar una colmena',0,0,1,0,0,0,NULL,NULL,NULL,NULL),
 ('S','R001','Revisión Mensual de Colmena','',0,0,0,0,0,0,NULL,NULL,NULL,NULL),
...
--
-- Definition of table `tratamientos`
--
...
--
-- Definition of view `todaslasactividades`
--

DROP TABLE IF EXISTS `todaslasactividades`;
DROP VIEW IF EXISTS `todaslasactividades`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `todaslasactividades` AS select `a`.`idActividad` AS `idActividad`,`a`.`codTipoActividad` AS `codTipoActividad`,`a`.`denominacion` AS `denominacion`,`a`.`descripcion` AS `descripcion`,`a`.`fechaCreacion` AS `fechaCreacion`,`a`.`fechaInicio` AS `fechaInicio`,`a`.`fechaFin` AS `fechaFin`,`a`.`idEstado` AS `idestado`,`a`.`observaciones` AS `observaciones`,`a`.`idApiar` AS `idApiar`,`ap`.`denominacion` AS `denomApiar`,`ap`.`estado` AS `estadoApiar`,`u`.`latitud` AS `latApiar`,`u`.`longitud` AS `longApiar` from ((`actividad` `a` join `apiar` `ap`) join `ubicacion` `u`) where ((`a`.`idApiar` = `ap`.`idApiar`) and (`ap`.`idUbicacion` = `u`.`idUbicacion`));
