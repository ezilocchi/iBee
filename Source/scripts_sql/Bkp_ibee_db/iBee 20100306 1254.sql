...
INSERT INTO `empleado` (`legajo`,`nombre`,`apellido`,`idEstadoEmpleado`,`idCargo`,`observaciones`,`usuario`,`password`,`fechaAlta`,`fechaBaja`,`email`) VALUES 
 (1,'Juan Martin','Possi',1,1,'No Comments','lalala','123','2009-08-29 00:00:00',NULL,'ibeeproject@gmail.com'),
...
CREATE TABLE `permisos` (
  `idPermiso` int(15) NOT NULL DEFAULT '0',
  ...
  `parametrizacion` tinyint(3) unsigned DEFAULT '1',
...
CREATE TABLE `zona` (
  ...
  `fechaBaja` datetime DEFAULT NULL,
  `observaciones` varchar(2500) DEFAULT NULL,
  `agroquimico` int(15) DEFAULT NULL,
  `flora` int(15) DEFAULT NULL,
  ...
  KEY `FK_zona_agro` (`agroquimico`),
  KEY `FK_zona_flora` (`flora`) USING BTREE,
  CONSTRAINT `FK_zona_agro` FOREIGN KEY (`agroquimico`) REFERENCES `agroquimico` (`idAgroquimico`),
  CONSTRAINT `FK_zona_flora` FOREIGN KEY (`flora`) REFERENCES `flora` (`idFlora`),
...
INSERT INTO `zona` (`idZona`,`zona`,`estado`,`fechaAlta`,`fechaBaja`,`observaciones`,`agroquimico`,`flora`,`tieneClima`,`idLocalidad`,`legajoUsuAlta`,`latitud`,`longitud`) VALUES 
 (1,'Gran Córdoba','Alta','2009-06-15 11:07:59',NULL,'No Obs',0,0,0,'ARCA0023',NULL,NULL,NULL),
 (2,'Valle de Traslasierra','Alta','2009-08-29 00:00:00',NULL,'No Obs',98,98,98,'ARCA5889',NULL,NULL,NULL),
 (3,'Falda Oriental Sierras Chicas','Alta','2009-08-29 00:00:00',NULL,'No Obs',98,98,98,'ARCA5109',NULL,NULL,NULL),
 (4,'Villa del Rosario','Alta','2009-08-29 00:00:00',NULL,'No Obs',98,98,98,'ARCA5963',NULL,NULL,NULL),
 (5,'Valle de Paravachasca','Alta','2009-08-29 00:00:00',NULL,'No Obs',98,98,98,'ARCA0001',NULL,NULL,NULL),
 (6,'Río Primero','Alta','2009-08-29 00:00:00',NULL,'No Obs',98,98,98,'ARCA5127',NULL,NULL,NULL),
 (7,'Valle de Calamuchita','Alta','2009-08-29 00:00:00',NULL,'No Obs',0,0,0,'ARCA5856',NULL,NULL,NULL),
 (8,'Villa de Soto','Alta','2009-08-29 00:00:00',NULL,'No Obs',0,0,0,'ARCA5284',NULL,NULL,NULL),
 (9,'Laguna Larga','Alta','2009-08-29 00:00:00',NULL,'No Obs',0,0,0,'ARCA5974',NULL,NULL,NULL),
 (10,'Penillanura','Alta','2009-08-29 00:00:00',NULL,'No Obs',0,0,0,'ARCA0076',NULL,NULL,NULL),
 (11,'Punilla','Alta','2009-08-29 00:00:00',NULL,'No Obs',0,0,0,'ARCA5184',NULL,NULL,NULL);
