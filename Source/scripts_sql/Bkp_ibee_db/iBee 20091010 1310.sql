...
--
-- Temporary table structure for view `enfermedades`
--
DROP TABLE IF EXISTS `enfermedades`;
DROP VIEW IF EXISTS `enfermedades`;
CREATE TABLE `enfermedades` (
  `idenfermedad` int(15),
  `denominacion` varchar(25),
  `descripcion` varchar(250),
  `duracionAproximada` varchar(25),
  `observaciones` varchar(500),
  `criticidad` varchar(25)
);

--
-- Temporary table structure for view `familias`
--
DROP TABLE IF EXISTS `familias`;
DROP VIEW IF EXISTS `familias`;
CREATE TABLE `familias` (
  `numeroFamilia` int(15),
...
--
-- Temporary table structure for view `gmaplatlng`
--
DROP TABLE IF EXISTS `gmaplatlng`;
DROP VIEW IF EXISTS `gmaplatlng`;
CREATE TABLE `gmaplatlng` (
  `idapiar` int(15),
  `denominacion` varchar(100),
  `estado` varchar(100),
  `latitud` decimal(15,5),
  `longitud` decimal(15,5)
);

--
-- Temporary table structure for view `sintomas`
--
DROP TABLE IF EXISTS `sintomas`;
DROP VIEW IF EXISTS `sintomas`;
...
--
-- Temporary table structure for view `tratamientos`
--
DROP TABLE IF EXISTS `tratamientos`;
DROP VIEW IF EXISTS `tratamientos`;
CREATE TABLE `tratamientos` (
  `idTratamiento` int(15),
  `denominacion` varchar(25),
