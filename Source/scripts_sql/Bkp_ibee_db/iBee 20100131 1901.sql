...
CREATE TABLE `alarma` (
  ...
  `rangoDesde` int(10) DEFAULT NULL,
  `rangoHasta` int(10) DEFAULT NULL,
...
INSERT INTO `alarma` (`idAlarma`,`idZona`,`denominacion`,`descripcion`,`origen`,`fechaCreacion`,`fechaInicio`,`fechaFin`,`idPeriodicidad`,`idTipoAlarma`,`idEstado`,`activado`,`rangoDesde`,`rangoHasta`) VALUES 
 (1,1,'Clima demasiado Bajo','Indica que la temperatura se mantuvo por debajo de los X grados...','Automatico','2009-06-15 00:00:00','2009-06-16 00:00:00','2009-06-25 00:00:00',2,1,0,1,15,40),
 (2,1,'Tarea NO FINALIZADA','Indica que la tarea posee mas de 5 dias de vencida','Actividades','2009-06-10 00:00:00','2009-06-12 00:00:00',NULL,1,1,0,0,NULL,NULL),
 (3,1,'Tarea NO FINALIZADA','Indica que la tarea posee mas de 10 dias de vencida','Actividades','2009-06-10 00:00:00','2009-06-12 00:00:00',NULL,1,2,0,0,NULL,NULL),
 (4,1,'Tarea NO FINALIZADA','Indica que la tarea posee mas de 15 dias de vencida','Actividades','2009-06-10 00:00:00','2009-06-12 00:00:00',NULL,1,3,0,0,NULL,NULL),
 (5,1,'La Zona no posee FLORA','Indica que la zona no es apta para buena producción','Flora','2009-06-10 00:00:00','2009-06-12 00:00:00',NULL,1,1,0,0,NULL,NULL),
 (6,1,'Demasiados Agroquimicos','Indica que la zona posee demasiados agroquimicos alrededor','Agroquimicos','2009-06-10 00:00:00','2009-06-12 00:00:00',NULL,1,1,0,0,NULL,NULL);
...
INSERT INTO `cajon` (`numeroCajon`,`descripcion`,`idEstadoCajon`,`LegajoUsuFab`,`fechafabricacion`,`observaciones`,`cantidadalzas`,`marcosporalza`,`idTipoCajon`) VALUES 
 ...
 (3,'Cajon AAA',2,1,'2009-06-15 00:00:00','No Obs',5,12,2),
 (4,'Cajon DDD',2,4,'2009-09-09 00:00:00','',5,10,1),
 (5,'Cajon HHH',1,1,'2009-10-12 00:00:00','',4,12,2);
...
INSERT INTO `colmena` (`numeroColmena`,`denominacion`,`fechaAlta`,`fechaBaja`,`numeroFamilia`,`idColmenaOriginal`,`idTipoMiel`,`numeroCajon`,`idPosicion`,`idEstadoColmena`) VALUES 
 ...
 (3,'Colmena Alfa','2009-09-19 00:00:00',NULL,3,NULL,1,2,NULL,1),
 (4,'Colmena 002','2009-09-19 00:00:00',NULL,2,NULL,1,4,NULL,1),
 (5,'Colmena Charbonier','2009-09-22 00:00:00',NULL,7,NULL,2,3,NULL,1),
 (6,'asdasd','2009-10-12 00:00:00','2009-10-12 00:00:00',1,NULL,1,1,NULL,1);
...
INSERT INTO `tratamiento` (`idTratamiento`,`denominacion`,`descripcion`,`costeo`) VALUES 
 (1,'MAXI VAL','100 % ante Varroasis',12),
 (2,'ANTI DOTO','Lo mejor contra todas las enfermedadesss',25),
