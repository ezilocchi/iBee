...
<!-- 
    Document   : Cajones
    Created on : 25-ago-2009, 22:29:04
        ...
        <html id="outputHtml1">
            ...
            <body id="outputBody1" style="-rave-layout: grid">
                ...
                <ice:panelGrid cellspacing="0px" columnClasses="columna1, columna2" columns="2" styleClass="tablaPrincipal">
                    ...
                    <ice:column>
                        <ice:form rendered="#{Cajones.consultar}">
                            <ice:panelCollapsible expanded="true" id="formConsultarPanelCajones">
                                <f:facet name="header">
                                    <ice:panelGroup>
                                        <ice:outputText id="formHeaderCajones" value="Cajones"/>
                                    </ice:panelGroup>
                                </f:facet>
                                <ice:panelGroup style="vertical-align: top;">
                                    <jsp:directive.include file="consultarCajon.jspf"/>
                                </ice:panelGroup>
                            </ice:panelCollapsible>
                        </ice:form>
                        <ice:form rendered="#{Cajones.agregar}">
                            <ice:panelCollapsible expanded="true" id="formAgregarPanelCajones">
                                <f:facet name="header">
                                    <ice:panelGroup>
                                        <ice:outputText id="formHeaderCajones" value="Cajones"/>
                                    </ice:panelGroup>
                                ...
                                <ice:panelGroup style="vertical-align: top;">
                                    <jsp:directive.include file="agregarCajon.jspf"/>
                                </ice:panelGroup>
                            </ice:panelCollapsible>
                        </ice:form>
                        <ice:form rendered="#{Cajones.modificar}">
                            <ice:panelCollapsible expanded="true" id="formModificarPanelCajones">
                                <f:facet name="header">
                                    <ice:panelGroup>
                                        <ice:outputText id="formHeaderCajones" value="Cajones"/>
                                    </ice:panelGroup>
                                ...
                                <ice:panelGroup style="vertical-align: top;">
                                    <jsp:directive.include file="modificarCajon.jspf"/>
                                </ice:panelGroup>
                            </ice:panelCollapsible>
                        </ice:form>
                        <ice:form id="eliminar" rendered="#{Cajones.eliminar}">
                            <ice:panelCollapsible expanded="true" id="formEliminarPanelCajones">
                                <f:facet name="header">
                                    <ice:panelGroup>
                                        <ice:outputText id="formHeaderCajones" value="Cajones"/>
                                    </ice:panelGroup>
                                ...
                                <ice:panelGroup style="vertical-align: top;">
                                    <jsp:directive.include file="eliminarCajon.jspf"/>
                                </ice:panelGroup>
                            </ice:panelCollapsible>
                        </ice:form>
                        <ice:form rendered="#{Cajones.consultarAll}">
                            <ice:panelCollapsible expanded="true" id="formConsultarAllPanelCajones">
                                <f:facet name="header">
                                    <ice:panelGroup>
                                        <ice:outputText id="formHeaderCajones" value="Cajones"/>
                                    </ice:panelGroup>
                                ...
                                <ice:panelGroup style="vertical-align: top;">
                                    <jsp:directive.include file="consultarCajones.jspf"/>
                                </ice:panelGroup>
                            </ice:panelCollapsible>
                        </ice:form>
                    </ice:column>
